<template>
  <div class="w-full h-screen flex items-center justify-center bg-gradient-to-br from-red-600 to-orange-500">
    <v-card class="w-full sm:w-96 px-8 py-10 text-center rounded-xl shadow-2xl">
      ...
      <div class="flex justify-between items-center mb-6">
        <v-checkbox label="Angemeldet bleiben" color="red-darken-2" hide-details></v-checkbox>
        <a href="register" class="text-sm text-orange-700 hover:underline">Passwort vergessen?</a>
      </div>
      ...
      <p class="text-sm text-gray-600">
        Noch kein Konto? 
        <a href="/register" class="text-orange-700 hover:underline">Registrieren</a>
      </p>
    </v-card>
    
    <v-snackbar v-model="snackbar" :timeout="5000" color="red-darken-2" rounded="pill">
...
async function login() {
  // Login logic (commented out in the original code)
}
